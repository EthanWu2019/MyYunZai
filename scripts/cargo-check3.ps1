...
cargo check 2>&1 | Out-File -Encoding UTF8 E:\YunZai_APP\cargo-check3.log
$lines = (Get-Content E:\YunZai_APP\cargo-check3.log -Encoding UTF8 | Measure-Object -Line).Lines
